    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
                <img src="https://drive.google.com/uc?id=1zCc2jMFJBG-235L7ruVgM2R87Ya5yRKW" class="img-fluid mb-5" alt="Phạm Minh Dũng">
                <h3><a href="#"><span class="">Phạm</span> Minh Dũng</a></h3>
            ...
            <!-- Start Column 2 -->
            <div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
                <img src="https://drive.google.com/uc?id=184Wz41-RJ0dF16ZFSP5htBrnbBJg6wpp" class="img-fluid mb-5" alt="Lê Ngọc Thanh Đào">
                <h3><a href="#"><span class="">Lê</span> Ngọc Thanh Đào</a></h3>
                <span class="d-block position mb-4">Nhà sáng lập, thiết kế.</span>
            ...
            <!-- Start Column 3 -->
            <div class="col-12 col-md-4 col-lg-4 mb-5 mb-md-0">
                <img src="https://drive.google.com/uc?id=1MFAGL_jxodfuKWBaS07PYZkuaamdRH7V" class="img-fluid mb-3" alt="Nguyễn Thị Mỹ Duyên" style="width: 300px; height: 400px;">
                <h3><a href="#"><span class="">Nguyễn</span> Thị Mỹ Duyên</a></h3>
                <span class="d-block position mb-4">Nhà sáng lập, thiết kế.</span>

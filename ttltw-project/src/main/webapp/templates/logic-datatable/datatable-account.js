$(document).ready(function () {
    $('#userData').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "http://localhost:8080/api/admin/account",
            type: "POST",
            dataType: "json",
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    ...
                    const deleteBtn = `<button onclick="deleteRecord(this, ${row.id}, 'account')" style="padding: 9px; margin-left: 4px;" data-bs-toggle="tooltip" title="Xóa ảnh" class="delete">

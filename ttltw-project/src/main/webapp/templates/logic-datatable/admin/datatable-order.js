    ...
    $('#orderData').DataTable({
        ...
        columnDefs: [
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    let allButton = '';
                    const updateBtn = `<a href="http://localhost:8080/admin/order-management/editing?id=${row.id}" data-bs-toggle="tooltip" title="Chỉnh sửa giỏ hàng "
                       class="edit">
                    ...
                    const deleteBtn = `<button onclick="deleteRecord(this, ${row.id}, 'order')" style="padding: 9px; margin-left: 4px;" data-bs-toggle="tooltip" title="Xóa ảnh" class="delete">

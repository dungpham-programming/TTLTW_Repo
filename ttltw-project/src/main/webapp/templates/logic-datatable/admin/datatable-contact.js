        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row, meta) {
                    if (data == 1) {
                        ...
                        return '<span class="badge bg-warning">Cần xác thực</span>';
                    } else if (data == 0) {
            ...
            },
            {
                ...
                render: function (data, type, row, meta) {
                    let allButton = '';
                    const updateBtn = `<a href="http://localhost:8080/admin/contact-management/editing?id=${row.id}" data-bs-toggle="tooltip" title="Chỉnh sửa liên hệ" class="edit">
                        <svg class="svg-inline--fa fa-pen-to-square" style="color: #e3bd74;" aria-hidden="true" focusable="false" data-prefix="far" data-icon="pen-to-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                    ...
                    const deleteBtn = `<button onclick="deleteRecord(this, ${row.id}, 'contact')" style="padding: 9px; margin-left: 4px;" data-bs-toggle="tooltip" title="Xóa liên hệ" class="delete">

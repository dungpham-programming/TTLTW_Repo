    ...
    <div class="container">
        <div class="table-responsive">
            <table id="orderHistory">
                ...
                %>
                <tr>
                    <th><%=orderDetail.getOrderId()%>></th>
                   <% if(orderDetail.getProductName()!=null){%>
                    <th><%= orderDetail.getProductName()%>></th>
                    <% } %>
                    <th><fmt:formatNumber value="<%=orderDetail.getOriginalPrice()%>" pattern="#,##0.##"/>đ</th>
                    <th><fmt:formatNumber value="<%=orderDetail.getDiscountPrice()%>" pattern="#,##0.##"/>đ</th>
        ...
        <div class="return-btn">
            <a href="order-history.html" class="checking-order-detail">Quay về đơn hàng</a>

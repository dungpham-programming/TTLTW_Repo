            ...
            <div class="col-3 pe-3 nav-left">
                <div class="nav-left-block">
                        ...
                        <ul class="nav-left-list">
                            ...
                            <li class="nav-left-item"><a
                                ...
                                <ul class="pop-right">
                                    ...
                                    %>
                                    <li class="pop-right-item"><a href="<c:url value="/shop-detail-by-type"/>" class="pop-right-link"><%=categoryType.getName()%>
                                    </a></li>
                                    <% } %>
                                </ul>
                            </li>
                    ...
                    <div class="sorting px-1">
                        <form action="<c:url value="/shop-detail-by-type">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="range" id="option4" value="none" <%if (range.equals("desc")) {%>checked<%}%>>

...
@WebServlet(value = {"/admin/client-home-management/editing"})
public class ClientHomeEditingController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (isValid) {
            ...
            try {
                linkImage1 = CloudStorageUtil.uploadtoCloudStorage(prLink1.getName(), prLink1.getInputStream());
                linkImage2 = CloudStorageUtil.uploadtoCloudStorage(prLink2.getName(), prLink2.getInputStream());
                backgroundImage = CloudStorageUtil.uploadtoCloudStorage(background.getName(), background.getInputStream());
